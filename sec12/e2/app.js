...
const addBlueButton = document.getElementById('addBackground')
...
// 	console.dir(addBlueButton)
// 	console.log(event)
// };

removeButton.addEventListener('click', removeParagraph);
addBlueButton.addEventListener('click', addBlueBackground);
...
function addBlueBackground(event) {
	console.log(event)
	firstPara.style.backgroundColor = 'rgb(0,0,255)'
};
